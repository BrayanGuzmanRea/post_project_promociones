"""
Django settings for post_project_promociones project.
...
SECRET_KEY = 'django-insecure-&a8m-y$jmb#jjc*tt_k0akf2arp4!mp^4n82xu@imc(l1vo-w='
...
WSGI_APPLICATION = 'post_project_promociones.wsgi.application'
